 ...
 */
public class Favorites extends AppCompatActivity implements AdapterForWordMeanings.ClickListener, AdapterForWordMeanings.OnRecyclerViewEmpty {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchFav.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                adapter = new AdapterForWordMeanings(context, filteredList, Favorites.this);
        ...
        if (data.isEmpty()) {
            ...
            adapter = new AdapterForWordMeanings(context, data, Favorites.this);
            adapter.setClickListener(Favorites.this);
            recyclerview.setAdapter(adapter);
            recyclerview.setLayoutManager(new LinearLayoutManager(context));
    ...
    public void itemClicked(int choice, View view) {
        ...
        if (choice == 0) {
            ...
            Intent i = new Intent(Favorites.this, LearnMoreFav.class);
