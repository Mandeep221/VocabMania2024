 ...
 */
public class LearnMoreFavActivity extends AppCompatActivity {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                if (newProgress < 100) {
                    ...
                    s.setSpan(new TypefaceSpan(LearnMoreFavActivity.this, "Roboto-Medium.ttf"), 0, s.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                ...
                if (newProgress == 100) {
                    ...
                    s.setSpan(new TypefaceSpan(LearnMoreFavActivity.this, "Nunito-Light.ttf"), 0, s.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
