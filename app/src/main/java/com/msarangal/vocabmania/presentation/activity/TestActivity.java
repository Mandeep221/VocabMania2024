...
import com.msarangal.vocabmania.util.Constants;
import com.msarangal.vocabmania.util.Message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        help.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TestActivity.this, HelpActivity.class);
        ...
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(TestActivity.this, LearnMoreFavActivity.class);
        ...
        favorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(TestActivity.this, FavoritesActivity.class);
                TestActivity.this.startActivity(i);
                overridePendingTransition(R.anim.card_slide_right_in, R.anim.card_slide_left_out);
            }
        });
   ...
   /* setup enter and exit animation */
    ...
    public void launchBeginnerTest() {
        ...
        if (eCount == 0 || eCount % 3 != 0) {
            ...
            if (total_entries == easyCapValue) {
                ...
                Intent i = new Intent(TestActivity.this, AllWordsOverActivity.class);
                ...
                Intent i = new Intent(TestActivity.this, QuestionsActivity.class);
            ...
            if (twelveHoursAheadTime - currentTime > 0) {
                Intent i = new Intent(TestActivity.this, BreakTimeActivity.class);
    ...
    public void launchRevision(Bundle bundle, int level) {
        if (bundle != null) {
            ...
            Intent i = new Intent(TestActivity.this, ReviseActivity.class);
