 ...
 */
public class AllRevisionWords extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterForRevision(context, data, data, AllRevisionWords.this);
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                adapter = new AdapterForRevision(context, filteredList, data, AllRevisionWords.this);
                recyclerview.setAdapter(adapter);
                recyclerview.setLayoutManager(new LinearLayoutManager(context));
